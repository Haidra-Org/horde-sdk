...
def test_HordeRequestSession_cleanup(simple_image_gen_request: ImageGenerateAsyncRequest) -> None:
...
def test_simple_client_image_generate_no_apikey_specified() -> None:
    simple_client = AIHordeAPISimpleClient()
...
def test_simple_client_image_generate_multiple(simple_image_gen_n_requests: ImageGenerateAsyncRequest) -> None:
    simple_client = AIHordeAPISimpleClient()
