...
from horde_sdk.ai_horde_api.apimodels._sharedkeys import SharedKeyDetailsResponse
from horde_sdk.ai_horde_api.apimodels.base import BaseAIHordeRequest, _BaseImageGenerateParamMixin
from horde_sdk.ai_horde_api.apimodels.generate.text._async import _BasePayloadKoboldMixin
...
class StyleImageExampleAddResponse(
    HordeResponseBaseModel,
    ContainsMessageResponseMixin,
    ContainsWarningsResponseMixin,
):
...
class StyleImageExampleAddRequest(
    ...
    @override
    @classmethod
    def get_default_success_response_type(cls) -> type[StyleImageExampleAddResponse]:
        return StyleImageExampleAddResponse
