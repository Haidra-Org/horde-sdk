...
class BasicTextGenerationParameters(BasicGenerationParameters):  # TODO: Non-AI-Horde specific constraints
    ...
    dynamic_temp_exponent: float | None = Field(1, ge=0.0, le=5.0)
    """Dynamic temperature exponent value."""
    dynamic_temp_range: float | None = Field(0, ge=0.0, le=5.0)
